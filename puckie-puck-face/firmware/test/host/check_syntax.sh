...
# headers, with thin stubs standing in for the Arduino/ESP32 core (see
# stubs/). This catches LVGL API misuse and plain C++ errors without needing
...
#
# Downloads (shallow git clone, cached in build/): lvgl v8.3.6.
